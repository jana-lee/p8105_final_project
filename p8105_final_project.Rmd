...
**[insert data sources]** Our team will use a publicly available dataset called the "Disaster Declarations Summary" (Version 2) from the Federal Emergency Management Agency (FEMA). This dataset encompasses declaration summaries from 1953 to 2019.
